...
The figure below shows the histogram of the steps taken each day, the mean value (`r mean_steps_day` steps, red) and the median value (`r median_steps` steps, blue)
